...
from QUANTAXIS_CRAWLY.run_selenium_alone import (read_east_money_page_zjlx_to_mongodb, open_chrome_driver, close_chrome_dirver)
import urllib
import pandas as pd
import time
...
def QA_read_eastmoney_zjlx_web_page_to_sqllite(stockCodeList = None):
    ...
    for indexCode in range(len(stockCodeList)):
        ...
        read_east_money_page_zjlx_to_mongodb(stockCodeList[indexCode], browser)
